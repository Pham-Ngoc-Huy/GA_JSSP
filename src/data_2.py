...
machine = [
    [1, 2, 3, 0],  # Part 1 operations
    [2, 3, 0, 1],  # Part 2 operations
    [3, 1, 2, 0],  # Part 3 operations
    [1, 3, 2, 0],  # Part 4 operations
    [3, 2, 1, 0]   # Part 5 operations
]
proc_time = [
    [3.0, 5.0, 2.0, 0.0],  # Part 1 processing times
    [2.0, 4.0, 0.0, 1.0],  # Part 2 processing times
    [4.0, 3.0, 2.0, 0.0],  # Part 3 processing times
    [5.0, 3.5, 4.0, 0.0],  # Part 4 processing times
